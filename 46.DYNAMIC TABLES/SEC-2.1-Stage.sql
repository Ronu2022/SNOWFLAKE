...
show stages; --> Observe for the internal stages no URL LINK
...
list @%customer; --> Table Stage

-- list user stage
list @~; --> User Stage.

-- if you check into the internal stages,then there is an option to load a file or download a file.
-- for external stage, there is no option to download or remove a file.
